...
from sensor.aws_cloud_storage.S3_bucket_syncer import S3Sync
...
class TrainPipeline:
    ...
    def sync_artifact_dir_to_s3(self):
        try:
            ...
            self.S3Sync.sync_folder_to_s3(folder = self.training_pipeline_config.artifact_dir,aws_buket_url=aws_buket_url)
        except Exception as e:
            raise SensorException(e,sys)
    ...
    def sync_saved_model_dir_to_s3(self):
        try:
            ...
            self.S3Sync.sync_folder_to_s3(folder=SAVED_MODEL_DIR,aws_bucket_url=aws_buket_url)
        except Exception as e:
            raise SensorException(e,sys)
