...
from sensor.machine_learning.model.estimator import TargetValueMapping
...
class DataTransformation:
    ...
    @classmethod
    def get_data_tranformer(cls)->Pipeline:
        try:
            """
            simple_imputer: missing value to be filled with 0
            """
            ...
            preprocessor = Pipeline(
                ...
                ("Robust Scaler",robust_scaler) # keep every feature in the same range and handle outliers
                ]
            )
            return  preprocessor
        except Exception as e:
